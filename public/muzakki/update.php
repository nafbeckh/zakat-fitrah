...
$muzazkki = new App\Muzakki();

if (isset($_GET["id"])) {
  $row = $muzazkki->edit($_GET["id"]);
} else {
  header('location:index');
}

if (isset($_POST["update"])) {
  $result = $muzazkki->update($_GET["id"]);
            ...
            <div class="form-row">
              <div class="form-col">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="nama" id="nama" placeholder="Nama Muzakki" value="<?=$row['nama'];?>" required />
                </div>
              </div>
              <div class="form-col">
                <div class="form-group">
